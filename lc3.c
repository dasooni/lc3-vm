...
// These are special memory locations that are used to communicate with the hardware
// For example, the keyboard status register tells us if a key has been pressed
enum
{
